...
public class DeviceTimerServiceImpl implements DeviceTimerService{
    ...
    public void createDeviceTimer(DeviceTimer deviceTimer) {
        ...
        //动态的添加定时的任务
        quartzManager.addJob(deviceTimerName, deviceTimerName, deviceTimerName, deviceTimerName, timJob.getClass(), "0 "+deviceTimer.getDeviceTimerMiner()+" " +deviceTimer.getDeviceTiemrHour()+" " +"? "+"* "+deviceTimer.getDeviceTiemrWeek()+" ",timerId);
